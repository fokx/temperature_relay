...
#ifndef SHT30_SHT3X_H
#define SHT30_SHT3X_H
...
// from Sensirion_Humidity_Sensors_SHT3x_Sample_Code_V2.pdf :: system.h
// Error codes
typedef enum {
...
// from Sensirion_Humidity_Sensors_SHT3x_Sample_Code_V2.pdf :: i2c_hal.h
// I2C acknowledge
typedef enum {
    ACK = 0,
    NACK = 1,
...
extern void init_sht3x(void);
extern etError read_temperature(int *temperature);
// extern void delay_ms(uint8 t);
#endif //SHT30_SHT3X_H
